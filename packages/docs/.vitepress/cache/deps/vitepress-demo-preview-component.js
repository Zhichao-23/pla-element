...
// ../../_node_modules/vitepress-demo-preview-component/_product/preview-component.js
var x = (o, e) => {
...
function J(o, e) {
  return openBlock(), createElementBlock("svg", G, e[0] || (e[0] = [
...
function W(o, e) {
  return openBlock(), createElementBlock("svg", Q, e[0] || (e[0] = [
    createBaseVNode("path", {
...
function ee(o, e) {
  return openBlock(), createElementBlock("svg", Y, e[0] || (e[0] = [
    createBaseVNode("path", {
...
function oe(o, e) {
  return openBlock(), createElementBlock("svg", ne, e[0] || (e[0] = [
    createBaseVNode("path", {
...
var ce = defineComponent({
  ...
  setup(o, { expose: e }) {
    ...
    return e({
      setVisible: _,
      setTopHeight: L
    }), (d, g) => (openBlock(), createBlock(Transition, {
      name: "slide-fade",
      onAfterLeave: p
    }, {
      default: withCtx(() => [
        l.value ? (openBlock(), createElementBlock("div", {
          ...
          createVNode(se),
          createBaseVNode("span", null, toDisplayString(d.content), 1)
...
var E = {
  open: () => {
    const o = document.createElement("div"), e = createApp(ce, {
      content: "复制成功！",
      close: () => {
...
var de = defineComponent({
  ...
  setup(o) {
    const e = o, t = F(), { isCodeFold: c, setCodeFold: l } = S(), { copyContent: _, clickCopy: m } = U(), L = ref(decodeURIComponent(e.code)), p = ref(decodeURIComponent(e.showCode)), d = ref(null), g = () => {
      m(L.value), E.open();
    }, h = computed(() => {
      var r;
    ...
    return onMounted(() => {
      ...
      const r = h.value;
      s(r);
    }), (r, f) => (openBlock(), createElementBlock("div", {
      ...
      createBaseVNode("section", {
        ...
        }, null, 10, ie)) : createCommentVNode("", true),
...
var pe = defineComponent({
  ...
  setup(o) {
    const e = o, t = F(), { isCodeFold: c, setCodeFold: l } = S(), { clickCopy: _ } = U(), m = ref(decodeURIComponent(e.code)), L = ref(decodeURIComponent(e.showCode)), p = ref(null), d = () => {
      _(m.value), E.open();
    }, g = computed(() => {
      var s;
    ...
    return onMounted(() => {
      ...
      const s = g.value;
      h(s);
    }), (s, r) => (openBlock(), createElementBlock("div", {
  ...
  setup(o) {
    ...
    return onMounted(() => {
      ...
      createBaseVNode("section", {
        ...
        e.title ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass([unref(t).bem("component", "name")])
      ...
      e.description ? (openBlock(), createElementBlock("section", {
        key: 0,
        class: normalizeClass([unref(t).bem("description")])
      }, [
...
export {
  ...
  pe as ElementPlusContainer,
  Ce as NaiveUIContainer
};
//# sourceMappingURL=vitepress-demo-preview-component.js.map
